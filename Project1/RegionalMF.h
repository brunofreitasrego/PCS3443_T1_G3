...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Click += gcnew System::EventHandler(this, &FMenu::HomeClick);
			// 
			// button2
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &FMenu::MRClick);
			// 
			// button4
			// 
			...
			this->button4->Click += gcnew System::EventHandler(this, &FMenu::button4_Click);
			// 
			// pictureBox1
			// 
			...
			this->pictureBox1->Click += gcnew System::EventHandler(this, &FMenu::pictureBox1_Click);
			// 
			// label1
			// 
			...
			this->label1->Click += gcnew System::EventHandler(this, &FMenu::label1_Click);
			// 
			// label2
			// 
