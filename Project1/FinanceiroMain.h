...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->treeView1->Size = System::Drawing::Size(244, 858);
			...
			this->button1->Click += gcnew System::EventHandler(this, &Main::FaturaClick);
			// 
			// button2
			// 
			this->button2->Location = System::Drawing::Point(12, 889);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(130, 42);
			this->button2->TabIndex = 6;
			this->button2->Text = L"Logout";
			this->button2->UseVisualStyleBackColor = true;
			this->button2->Click += gcnew System::EventHandler(this, &Main::LogoutClick);
			// 
			// Main
			// 
