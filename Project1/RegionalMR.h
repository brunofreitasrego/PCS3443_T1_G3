...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Click += gcnew System::EventHandler(this, &MReparos::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &MReparos::MFClick);
			// 
			// button3
			// 
			...
			this->button4->Click += gcnew System::EventHandler(this, &MReparos::button4_Click);
			// 
			// pictureBox1
			// 
			...
			this->pictureBox1->Click += gcnew System::EventHandler(this, &MReparos::pictureBox1_Click);
			// 
			// label1
			// 
			...
			this->label2->Click += gcnew System::EventHandler(this, &MReparos::label2_Click);
			// 
			// label3
			// 
			...
			this->label5->Location = System::Drawing::Point(517, 60);
