...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// tb_login
			// 
			this->tb_login->Location = System::Drawing::Point(144, 82);
			this->tb_login->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->tb_login->Name = L"tb_login";
			this->tb_login->Size = System::Drawing::Size(148, 26);
			this->tb_login->TabIndex = 4;
			// 
			// lb_login
			// 
			this->lb_login->AutoSize = true;
			this->lb_login->Location = System::Drawing::Point(68, 86);
			this->lb_login->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			...
			this->lb_senha->Location = System::Drawing::Point(63, 148);
			this->lb_senha->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			...
			// tb_senha
			// 
			this->tb_senha->Location = System::Drawing::Point(144, 148);
			this->tb_senha->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->tb_senha->Name = L"tb_senha";
			this->tb_senha->PasswordChar = '*';
			this->tb_senha->RightToLeft = System::Windows::Forms::RightToLeft::No;
			this->tb_senha->Size = System::Drawing::Size(148, 26);
			this->tb_senha->TabIndex = 7;
			this->tb_senha->UseSystemPasswordChar = true;
			// 
			// bt_validar
			// 
			this->bt_validar->Location = System::Drawing::Point(72, 225);
			this->bt_validar->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->bt_validar->Name = L"bt_validar";
			this->bt_validar->Size = System::Drawing::Size(112, 35);
			...
			// bt_limpar
			// 
			this->bt_limpar->Location = System::Drawing::Point(219, 225);
			this->bt_limpar->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->bt_limpar->Name = L"bt_limpar";
			this->bt_limpar->Size = System::Drawing::Size(112, 35);
			...
			this->lb_mensagem->Location = System::Drawing::Point(140, 280);
			this->lb_mensagem->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->lb_mensagem->Name = L"lb_mensagem";
			this->lb_mensagem->Size = System::Drawing::Size(145, 20);
			this->lb_mensagem->TabIndex = 10;
			this->lb_mensagem->Text = L"Mensagens de Log";
			// 
			// tb_mensagem
			// 
			this->tb_mensagem->Location = System::Drawing::Point(72, 305);
			this->tb_mensagem->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->tb_mensagem->Multiline = true;
			this->tb_mensagem->Name = L"tb_mensagem";
			this->tb_mensagem->Size = System::Drawing::Size(301, 56);
			...
			this->menuStrip1->Size = System::Drawing::Size(476, 35);
			...
			this->aboutToolStripMenuItem->Size = System::Drawing::Size(256, 30);
			...
			this->exCaixaDeDialogoToolStripMenuItem->Size = System::Drawing::Size(256, 30);
			...
			this->sairToolStripMenuItem->Size = System::Drawing::Size(256, 30);
			...
			this->ClientSize = System::Drawing::Size(476, 405);
